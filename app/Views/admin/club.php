                ...
                <div class="card-body">
                    <div class="table-responsive" style="overflow-x: initial;">
                        <table id="basic-1" class="display">
                            ...
                            <tbody>  
                                <?php $no = 1; ?>
                                <?php foreach($clubs->getResultObject() as $club) : ?>                                                                      
                                    <tr>    
                                        <td class="text-center"><?= $no++ ?></td>
                                        <td class="text-center"><?= $club->nama_club ?></td>
                                        <td class="text-center"><?= $club->manager ?></td>
                                        <td class="text-center"><?= $club->coach ?></td>
                                        <td class="text-center"><?= $club->email ?></td>
                                        <td class="text-center"><?= $club->wa ?></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody> 
                        </table>
